	...
	<div>
		...
		<div class="col-8">
			...
			if(session.getAttribute("userid") != null) { %>
				<div>
					<h3 class="h-normal fs-28"><i class="fi fi-rr-pencil"></i> 글 작성</h3>
					<form action="insertBoard" method="post" role="form" id="insert-board-form">
						<table>
							<tr>
						...
						<button type="submit" class="btn small green is-shadow" id="submit-btn">완료</button>
					</form>
				</div>
			<% }
			/* 로그인이 되어 있지 않을 때 */
